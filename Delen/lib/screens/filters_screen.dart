...
enum problems { badqualitytoy, badservice, latedeliveries }

class _FiltersScreenState extends State<FiltersScreen> {
  problems selectedButton = problems.badqualitytoy;
  var rangenumber;
  var reportCount=0;
                      ...
                      onPressed: () async {
                        ...
                        try {
                          ...
                          await Firestore.instance
                            ...
                            'toyDescription': documents[i]['description'],
