    ...
    return Scaffold(
        ...
        builder: (ctx) {
          ...
          return AlertDialog(title:Text("Oops something went wrong"),content: FittedBox(
                child: Column(
              children: <Widget>[
                Text(err.message==null?"sorry for inconvenience":message),IconButton(
        ...
        builder: (ctx) {
          ...
          return AlertDialog(title:Text("Oops something went wrong"),content: FittedBox(
                child: Column(
              children: <Widget>[
                Text("Sorry for the inconvenience"),IconButton(
                    icon: Icon(Icons.arrow_back),
                    onPressed: () {
                      Navigator.of(context).pop();
                    })])));});
        ...
        body: Container(
          child: ListView(
            children: <Widget>[
              ...
              Container(
                child: ListTile(
                  title: Text('Toy Description:',
                      style:
                          TextStyle(fontWeight: FontWeight.bold, fontSize: 20)),
                  subtitle: Text(userData['toyDescription'],
                      style: TextStyle(fontSize: 20)),
                ),
              ),
              Divider(
