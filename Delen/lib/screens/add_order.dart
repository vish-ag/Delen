                      ...
                      child: FlatButton(
                        ...
                        onPressed: () {
                          ...
                          DatePicker.showDatePicker(context,
                              ...
                              maxTime: DateTime.now().add(Duration(hours: 240)),
                              onConfirm: (date) {
                            print('confirm $date');
                            _date =
                                    ...
                                    builder: (ctx) {
                                      return AlertDialog(
                                          ...
                                          content: FittedBox(
                                            ...
                                            SizedBox(height: 10),
                                            Text(
                                                ' Pickup up time should be within 10 days from now ',
                        ...
                        return AlertDialog(
                          ...
                          content: Column(
                            ...
                            children: <Widget>[
                              ...
                              SizedBox(height: 5),
                              Text(
                                'We assume that you take the responsibility of the toy you donate.',
