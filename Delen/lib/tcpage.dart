                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Text(
                          'This Terms and Conditions Agreement sets forth the standards of use of the Toy Donation service, (“Delen Pvt.Ltd”) Online Service. By using the Delen app, you (the ”User”) agree to these terms and conditions. If you do not agree to the terms and conditions of this Agreement, you should immediately cease all usage of this application. We reserve the right, at any time, to modify, alter, or update the terms and conditions of this agreement without prior notice. Modifications shall become effective immediately upon being posted at Delen Application. Your continued use of the Service after amendments are posted constitutes acknowledgement and acceptance of the Agreement and its modifications. Except as provided in this paragraph, this Agreement may not be amended.'),
                      ...
                      Text(
                          '2.1.   We are a toy donation service provider providing you an online platform to (a) donate toys online to whomever needs it and (b) receive toys online from the list of donors (the public or an organisation) available on the Services.'),
                      Text(
                          '2.2.   We do not own, sell, resell, furnish, provide, prepare, manage and/or control the manufacturers or the related services provided in connection thereof.'),
                      Text(
                          '2.3.   Our responsibilities are limited to: (i) facilitating the availability of the Donor Services; and (ii) serving as the limited agent of each receiver for the purpose of accepting donation from the list of donors.'),
                      Divider(color: Colors.black),
                      Padding(
                        padding: EdgeInsets.all(20),
                      ...
                      Text(
                          '3.5.   We reserve the right to suspend or terminate your Delen Application Account and your access to the Services if any information provided during the registration process or thereafter provided is inaccurate, not current or incomplete.'),
                      Divider(color: Colors.black),
                      Padding(
                        padding: EdgeInsets.all(20),
                      ...
                      Text(
                          '4.1.   Any contract for the supply of Toy Pick Up from this application is between you and the Participating Donor. You agree to take particular care when providing us with your details and warrant that these details are accurate and complete at the time of ordering. '),
                      Text(
                      ...
                      Text(
                          '4.3.   Once the ordered toy is ready to pick up, the confirmation message will specify pick up details including the approximate pickup time and the name of donor.'),
                      Divider(color: Colors.black),
                      Padding(
                        padding: EdgeInsets.all(20),
                      ...
                      Text(
                          '5.1.   Pick Up period quoted at the time of ordering are approximate only and may vary. Toy has to be picked up from the address as informed to you while donating. '),
                      Text(
                          '5.2.   If you fail to pick up the Toy at the time they are ready for pick up then all risk and responsibility in relation to such Toy shall pass to you. And you shall be removed from Delen in the future. '),
                      Text(
                          '5.3.   Once you have succeeded in picking up the toy, it is your responsibility to click on the ‘Toy Received’ button on the Application to avoid mistakes.'),
                      Divider(color: Colors.black),
                      Padding(
                        padding: EdgeInsets.all(20),
